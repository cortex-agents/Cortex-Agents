...
export default function AboutPage() {
  return (
    <main className="relative min-h-screen w-full overflow-hidden text-slate-100 font-sans pb-32">
            ...
            {[
              ...
              >
                <div className="text-5xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-purple-500 mb-2">
                  <AnimatedCounter end={stat.num} /><span className="text-sky-400">{stat.suffix}</span>
                </div>
      ...
      {/* SECTION 6: TEAM (Imported Component) */}
      ...
      <section className="relative py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-px bg-slate-800 -translate-x-1/2">
             <motion.div 
                className="w-full bg-gradient-to-b from-sky-400 to-purple-500 origin-top"
                initial={{ scaleY: 0 }}
          ...
          <div className="space-y-16">
            {[
              ...
              >
                <div className={`flex-1 w-full md:text-${i % 2 === 0 ? 'left' : 'right'}`}>
