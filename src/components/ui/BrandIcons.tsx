...
// This avoids importing the heavy react-icons package (~1MB)
...
// Generic fallback for any profile that has no dedicated brand mark
// (personal site, Behance, Dribbble, Dev.to, …).
