...
const teamMembers = [
  ...
  },
  {
    ...
    description:
      "Crafting elegant, intuitive interfaces and intelligent AI agents people love.",
    image: "/taha.jpg",
  ...
  },
  {
    ...
    description:
      "End-to-end development with focus on performance and scalability.",
    image: "/ahsan.jpeg",
            ...
            >
              <div className="relative bg-gray-900/80 backdrop-blur-xl border border-gray-700/30 rounded-2xl overflow-hidden h-full transition-all duration-500 hover:border-gray-600/50 hover:shadow-2xl">
                ...
                <div className="relative aspect-[4/5] overflow-hidden sm:aspect-square md:aspect-[4/5] lg:aspect-[3/4] rounded-t-2xl">
                  ...
                  <div
                    className={`absolute top-4 right-4 p-3 rounded-xl bg-gradient-to-br ${member.gradient} shadow-lg group-hover:scale-110 transition-transform duration-300`}
                  >
                ...
                <div className="p-6 relative z-10">
                  ...
                  <p
                    className={`text-sm font-semibold mb-3 bg-gradient-to-r ${member.gradient} text-transparent bg-clip-text`}
                  >
                    {member.role}
                  </p>
                ...
                <div
                  className={`absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr ${member.gradient} opacity-0 group-hover:opacity-10 blur-3xl transition-opacity duration-500`}
                />
              </div>
            </motion.div>
          ))}
